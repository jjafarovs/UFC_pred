...
st.sidebar.caption(
    ...
    "**Original** (avg>62%/<38%, confirm>=55%/<=45%): backtested ROI +5.9%, "
    "95% CI [+1.2%,+10.7%] -- statistically significant. "
    "**Tighter** (avg>75%/<25%, same confirm floor): backtested ROI +9.3%, "
    "95% CI [+3.5%,+14.7%] -- statistically significant, found via a threshold sweep. "
    "**Refined** (same thresholds as Original, plus: both fighters need >=3 tracked "
    "fights, and title fights are excluded): backtested ROI +11.0%, 95% CI "
    "[+4.3%,+17.7%] -- the strongest and most robust result found so far, significant "
